  ...
  <style>
    ...
    .ftco-navbar-light .navbar-nav > .nav-item > .nav-link{
      ...
      .form-control {
        ...
        padding: 20px;
        font-size: 1.1rem;
        height: auto; /* Ensures larger height */
      }
            ...
            <ul class="navbar-nav ml-auto">
              ...
              <li class="nav-item active d-flex align-items-center">
                          ...
                          <form  id="logout-form" action="{{ route('logout') }}" method="POST" class="d-inline">
                              @csrf
                              <button type="submit" class="nav-link active btn text-dark">Logout</button>
                          </form>

                </li>
              @else
                <li class="nav-item active"><a href="/register" class="btn mx-1 my-3">Register</a></li>
                <li class="nav-item active"><a href="/login" class="btn  my-3">Login</a></li>
              @endif
            </ul>
          </div>
        </div>
            ...
            <div class="col-md-10">
                <div class="card shadow-sm" style="background-color: #f8f8f8;">
                    <div class="row no-gutters">
                        <div class="col-md-6 p-4">
                            ...
                            <form action="/upload_contact" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="date" id="date" name="date" min="{{ \Carbon\Carbon::today()->toDateString() }}" class="form-control" required>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <img src="user/images/image_2.jpg" alt="Location Image" class="img-fluid" style="object-fit: cover; height: 100%;">
                          </div>
                    </div>
                </div>
            </div>
